...
"""
Задача 8 (сложная)
Напишите рекурсивную функцию для генерации всех перестановок строки.

"""

"""
Задача 9 (сложная)
Создайте функцию с использованием замыканий, которая будет создавать функции-умножители на заданное число.

"""

"""
Задача 10 (очень сложная объемная)
